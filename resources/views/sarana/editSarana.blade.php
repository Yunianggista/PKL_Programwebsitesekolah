  ...
  <!-- Horizontal Form -->
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit Sarana</h3>
            ...
            <form method="post" action="{{ url()->current()}}"class="form-horizontal">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="{{$data->jenis}}" class="form-control" placeholder="Masukkan Jenis" name="jenis">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="{{$data->letak}}"  class="form-control"placeholder="Masukkan Letak" name="letak">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" value="{{$data->jumlah}}" class="form-control"placeholder="Masukkan Tanggal" name="jumlah">
