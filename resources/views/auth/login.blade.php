...
<div class="container">
    <div style="background: rgba(46, 51, 56, 0.7)">
      <h1 class="text-center huge">SMP 3 Selomerto</h1>
       <h4 class="text-center">Mewujudkan peserta didik yang berbudi pekerti luhur, bermutu dan berwawasan lingkungan</h4>
    </div>
    <div class="col-md-3">
