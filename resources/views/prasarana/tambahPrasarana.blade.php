            ...
            <form method="post" action="{{ url()->current()}}"class="form-horizontal">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control"placeholder="Masukkan Panjang" name="panjang">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control"placeholder="Masukkan Lebar" name="lebar">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control"placeholder="Masukkan Presentase Kerusakan" name="presentase">
